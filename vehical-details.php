    ...
    <div class="listing_detail_head row">
      ...
      <div class="col-md-3">
        <div class="price_info">
          <p>$<?php echo htmlentities($result->PricePerDay);?> </p>Per Session
        ...
        <div class="listing_more_info">
          <div class="listing_detail_wrap">
            ...
            <ul class="nav nav-tabs gray-bg" role="tablist">
              <li role="presentation" class="active"><a href="#vehicle-overview " aria-controls="vehicle-overview" role="tab" data-toggle="tab">Service Overview </a></li>

              <li role="presentation"><a href="#accessories" aria-controls="accessories" role="tab" data-toggle="tab">How to Access</a></li>
            </ul>
          ...
          <div class="product-listing-m gray-bg">
            ...
            <div class="product-listing-content">
             ...
             <li><i class="fa fa-user" aria-hidden="true"></i><?php echo htmlentities($result->SeatingCapacity);?> sessions</li>
                ...
                <li><i class="fa fa-car" aria-hidden="true"></i>offered at/by <?php echo htmlentities($result->FuelType);?></li>
              </ul>
            </div>
          </div>
        </div>
