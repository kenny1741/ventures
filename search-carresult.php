...
<title> Portal | Service Listing</title>
<!--Bootstrap -->
...
<link href="https://fonts.googleapis.com/css?family=Lato:300,4,700,900" rel="stylesheet">
</head>
<body>
      ...
      <aside class="col-md-3 col-md-pull-9">
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-filter" aria-hidden="true"></i> Find Your Services </h5>
          </div>
		...
		<?php }} ?>
							...
							<div class="form-group select">
								<select class="form-control" name="fueltype">
									<option>Select Service venue</option>
        ...
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-car" aria-hidden="true"></i> Recently Listed Services</h5>
          </div>
